    ...
    <h6 style="color:white;">Formulário de Geração</h6>
      ...
      <!--<br><input type="text" ng-model="nome" placeholder="*Insira seu Nome" require="" class="ng-valid ng-not-empty ng-dirty ng-valid-parse ng-touched">-->
        ...
        <div class="input-group mb-3">
          ...
          <input type="text" ng-model="cargo" class="form-control" placeholder="*Insira seu Cargo" aria-label="cargo" aria-describedby="basic-addon1">
        </div>
...
<!--
    ...
    <table width="540px" height="190px">
      <tbody><tr>    
        <td id="about" class="img-fluid" style="margin:-5px;font-family:tahoma,arial,verdana; font-size:12px;background-repeat: no-repeat; width:559px; height:auto; background-size:103%; background-image:url('imgs/assinatura-regiao_saca.png');"><br>
          ...
          <strong style="color: #007129;padding-left: 18px; font-size: 12px;" class="ng-binding"><i class="fa fa-map-marker" aria-hidden="true"></i> INTS REGIÃO SACA</strong>
          <br><br><br><br>
          </td>
        </tr></tbody></table>
        <br><br>
